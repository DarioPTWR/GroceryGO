    ...
    return (
        <SafeAreaView className="h-screen bg-[#fff4ec]">
            ...
            <View className="w-80 mx-auto mb-10">
                    <FormInput name={"Email / Username"} Input={emailUsername} setInput={setEmailUsername} secure={false} validate={()=>{}}/>
                    <FormInput name={"Password"} Input={password} setInput={setPassword} secure={true} validate={()=>{}}/>
